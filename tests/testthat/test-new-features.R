...
test_that("plan mode exit requires a trusted in-session transition", {
  expect_identical(check_permission("ExitPlanMode", "plan"), "deny")
  expect_identical(
    check_permission("ExitPlanMode", "plan", allow_plan_exit = TRUE),
    "allow")
