...
- [Getting started with
  codeagent](https://kaipingyang.github.io/codeagent/articles/getting-started.md):
...
- [技能与斜杠命令](https://kaipingyang.github.io/codeagent/articles/skills-usage-cn.md):
- [多智能体团队协调](https://kaipingyang.github.io/codeagent/articles/team-coordination-cn.md):
- [使用 codeagent
  探索数据](https://kaipingyang.github.io/codeagent/articles/data-exploration-cn.md):
- [将 codeagent 嵌入为后端（契约
  v1，简体中文）](https://kaipingyang.github.io/codeagent/articles/backend-integration-cn.md):
- [可移植的工具结果工件（简体中文）](https://kaipingyang.github.io/codeagent/articles/tool-artifacts-cn.md):
- [数据盾（Data
