...
<img src="diagrams/svg/entrypoint-call-map.svg" alt="从codeagent_client到one-shot、console、stream和Shiny入口，再到共享turn、provider、artifact和session服务的代码地图" style="width:100%;height:auto;" loading="lazy" />
...
<img src="diagrams/svg/core-module-dependencies.svg" alt="query、stream和turn lifecycle周围的context、安全、presentation和persistence模块依赖图" style="width:100%;height:auto;" loading="lazy" />
...
<img src="diagrams/svg/multi-agent-ownership.svg" alt="Parent client、foreground Agent clone、live Data Shield、team workers和SQLite board、background process fail-closed规则的ownership地图" style="width:100%;height:auto;" loading="lazy" />
