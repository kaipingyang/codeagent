...
<img src="diagrams/svg/agent-turn-lifecycle.drawio.svg" alt="codeagent 一轮交互：用户输入、输入安全、turn setup、provider与工具轮次、回复finalize、输出安全和session持久化" style="width:100%;height:auto;" loading="lazy" />
...
<img src="diagrams/svg/tool-safety-pipeline.drawio.svg" alt="工具调用安全链：pre-gate preview、中央权限门、Data Shield ingress、审批、PreToolUse改参和重新检查、执行、结果过滤、PostToolUse与normalization" style="width:100%;height:auto;" loading="lazy" />
...
<img src="diagrams/svg/context-compaction-lifecycle.drawio.svg" alt="每个provider request前的上下文管理：pending turn、资源替换、token accounting、micro-snip、history重建、fresh recount、可选摘要、结构验证和PTL恢复" style="width:100%;height:auto;" loading="lazy" />
